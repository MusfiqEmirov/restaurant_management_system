"""
Django settings for the restora_project project.
...
BASE_DIR = Path(__file__).resolve().parent.parent  # This points to the root folder of the project
load_dotenv(BASE_DIR / '.env')  # Load the .env file

# Django settings
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-default-key')
DEBUG = True  # Debug mode should be enabled
...
AUTH_USER_MODEL = 'accounts.User'  # Specify custom user model instead of the default User model
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  # Public access for registration
    ),
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,  # for logout
    'BLACKLIST_AFTER_ROTATION': True,  # for logout
